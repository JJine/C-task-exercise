                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        @if(isset($errors['userid']))
                            <input type="text" class="form-control is-invalid" id="userid" name="userid" placeholder="사용자 ID을 입력하세요"> 
                            <div class="invalid-feedback">
                            {{$errors['userid']}}
                            </div>
                        @else
                            <input type="text" class="form-control" id="userid" name="userid" placeholder="사용자 ID을 입력하세요">
                        @endif
                    </div>
                </div>
                <div class="form-group row">
