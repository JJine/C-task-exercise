<link rel="stylesheet" href="./B Module/style.css">
    <script src="/B Module/js/App.js"></script>
    <script src="/B Module/js/Line.js"></script>
    <script src="/B Module/js/Rect.js"></script>
    <script src="/B Module/js/Tool.js"></script>
    <script src="/B Module/js/jquery-3.3.1.min.js"></script>
    <script src="/B Module/js/Viewport.js"></script>
<!-- <div id="wrap"> -->
...
<form id="part-form" method="post">
    <input type="hidden" id="movie_id" name="movie_id"> <!--movie_id 5개 중에 무엇을 선택했는지 확인시킴-->
...
<script>
    window.addEventListener ("load", ()=> {
        document.querySelector("#part-btn").addEventListener("click", () => {
            if(!app.viewport.videoId) return alert("영화를 선택해주세요!");
            document.querySelector("#html").value = app.parseHTML();
            document.querySelector("#movie_id").value = app.viewport.videoId;
            console.log(app.viewport.videoId);
